...
function TrustedCustomers() {
  return (
    <div className="w-100 mt-20 flex  flex-col justify-center space-y-10 overflow-hidden bg-slate-100 px-8 py-8">
      <span className="text-2xl">Trusted by 20,000+ customers across Europe</span>
      <div
        className="flex justify-between overflow-hidden"
        style={{ width: "200%" }}
      >
        <img
          className="animate-slide-show animate-infinite"
        ...
        <img
          className="animate-slide-show animate-infinite"
          src="https://prismic-io.s3.amazonaws.com/commercial-helios/53d1e19a-6258-45cf-b841-156bd8240cb3_Byron.svg"
          alt=""
          width="100px"
          height="60px"
          loading="lazy"
        ...
        <img
          className="animate-slide-show animate-infinite"
          src="https://prismic-io.s3.amazonaws.com/commercial-helios/5ca6d664-efd4-4ed4-9ec9-b148adf40a14_IDC.svg"
          alt=""
          width="100px"
          height="60px"
          loading="lazy"
